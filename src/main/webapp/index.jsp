...
<head>
    ...
    <title>Nagaraj Jalawadi's DevOps Lab.</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Nagaraj Jalawadi's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is Nagaraj Jalawadis DevOps AWS Lab</p>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h2>Nexus</h2>
            <p>I have used Nexus3 as my maven repository maNagaraj Jalawadier. Jenkins will publish the artifacts to Nexus after succesful build </p>
            <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-4">
            <h2>Jenkins</h2>
    ...
    <footer>
        <p>&copy; Nagaraj Jalawadi's devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
